    ...
    <section id="features" style={{
      ...
      <div style={{ maxWidth:1160, margin:"0 auto", paddingInline:24, position:"relative", zIndex:1 }}>
        <motion.div initial={{ opacity:0,y:20 }} whileInView={{ opacity:1,y:0 }}
          ...
          <span style={{ display:"inline-block", fontFamily:"'Plus Jakarta Sans',monospace", fontSize:"0.65rem", letterSpacing:"0.2em", textTransform:"uppercase", color:t.textFaint, marginBottom:16 }}>
            What's inside
          </span>
          ...
          <p style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:"1rem", color:t.textMuted, marginTop:14, maxWidth:460, marginInline:"auto", lineHeight:1.6 }}>
          ...
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 style={{ fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:700,fontSize:"1rem",letterSpacing:"-0.02em",color:t.text,margin:"0 0 8px" }}>{f.title}</h3>
                <p style={{ fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:400,fontSize:"0.82rem",color:t.textFaint,margin:0,lineHeight:1.65 }}>{f.description}</p>
              </motion.div>
            );
          })}
        </div>
